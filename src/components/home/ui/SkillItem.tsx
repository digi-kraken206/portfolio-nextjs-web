...
const SkillItem = ({ data }: { data: ISkillListItem }) => {
  return (
    <CardBox classNames="py-4 px-6 items-center justify-start rounded-[var(--borderRadius)] border border-[rgba(255,255,255,0.10)] dark:bg-[var(--primaryColor5)] bg-[var(--primaryColor5)] shadow-[2px_4px_16px_0px_rgba(100,100,100,0.06)_inset] w-full group">
